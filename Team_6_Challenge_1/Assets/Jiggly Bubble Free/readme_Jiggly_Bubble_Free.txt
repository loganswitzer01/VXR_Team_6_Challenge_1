...
As per the End User License Agreement of Asset Store (https://unity3d.com/legal/as_terms), you are strictly prohibited from reproducing, distributing, or sub-licensing this asset. 
For more information, please refer to the online asset description page: http://u3d.as/sew. 
This asset has a paid version with more particle effects for different situations: http://u3d.as/sae.

To use the "bubble cubemap" material properly, replace the "cubemap test" with any formal cubemap in a similar 6-frame layout. 
...
Please email us (moonflowercarnivore@gmail.com) for any inquiries.
...
如使用素材「bubble cubemap」，请将预设的「cubemap test」替换成正式的立方体贴图，其6格展开编排应该类似于cubemap test。 
